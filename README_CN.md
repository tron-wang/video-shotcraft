...
**让 agent 帮你制作电影感产品视频的 skill：167 张镜头配方卡 · 224 个样式 · 224 条动态样片 · 已验收成片模板**
...
🖼️ [**在线 Gallery：浏览全部 224 条动态样片 »**](https://shotcraft-gallery.nionionote.com/)
...
| 224 条动态样片 | 覆盖 224 个样式，可在在线 Gallery 中直接预览、搜索和筛选 |

...
- 位置固定在左下：直式 x=60、y=1630（字幕 y≈1480–1560 的下方、平台说明区 y≥1720 的上方）；不靠右——直式右缘 x>900、y 900–1700 是平台按钮
...
|---|---|---|
| 左上角 | x 60、y 1630 | x 120、y 1000 |
| 字号 / 内距 | 30px、12×22 | 26px、10×20 |
| 占用高度 | ≈ y 1630–1690（版面表给的带是 1620–1700） | ≈ y 1000–1046（带 1000–1050） |
...
- **压在亮素材上**：满版照片 / 截图的亮区落在 y≈1630 时，0.78 的底板会透出底下的亮色，前缀那段 72% 的字先读不清。把 `plate` 提到 0.86–0.9；不要改用白底黑字（跟字幕板不成一套）、也不要加描边或投影。素材装在 SAFE 面板里时条落在底色上，没有这个问题。
